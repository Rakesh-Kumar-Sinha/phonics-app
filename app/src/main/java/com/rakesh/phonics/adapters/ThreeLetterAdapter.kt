...
class ThreeLetterAdapter(
    private val context: Context,
    private val letters: ArrayList<TripleLetter>
) : RecyclerView.Adapter<ThreeLetterAdapter.LetterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LetterViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_tripple_letter, parent, false)
    ...
    override fun onBindViewHolder(holder: LetterViewHolder, position: Int) {
        ...
        holder.btnBothLetter.text =
            data.letterOne.lowercase() + data.letterTwo.lowercase() + data.letterThree.lowercase()
