...
class SplitDigraphsAdapter(
    private val context: Context,
    private val letters: ArrayList<SplitDigraphs>,
    private val onItemClick: (folderName: String) -> Unit
) : RecyclerView.Adapter<SplitDigraphsAdapter.SplitDigraphsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SplitDigraphsViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_digraph, parent, false)
        return SplitDigraphsViewHolder(view)
    }

    override fun onBindViewHolder(holder: SplitDigraphsViewHolder, @SuppressLint("RecyclerView") position: Int) {
...
//            val folderName = if (pathParts.size >= 2) pathParts[1] else item.text.replace(" ", "_")
    ...
    override fun onViewRecycled(holder: SplitDigraphsViewHolder) {
    ...
    class SplitDigraphsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
